...
btn[0].onclick = function () {
  productImg.src = "images/kaos putih.jpeg";
  for (bt of btn) {
...
btn[1].onclick = function () {
  productImg.src = "images/kaos abu abu.jpg";
  for (bt of btn) {
    bt.classList.remove("active");
  }
  this.classList.add("active");
...
btn[2].onclick = function () {
  productImg.src = "images/kaos hitam.jpeg";
  for (bt of btn) {
    bt.classList.remove("active");
  }
  this.classList.add("active");
...
const maxStock = 20; // Set stock limit here
