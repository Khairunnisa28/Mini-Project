function upadateCaseNumber(product, price, isIncreasing){
    ...
    function calculateTotal(){
        const blueTotal = getInputvalue('blue') * 1219;
        const blackTotal = getInputvalue('black') * 59;
        const subTotal = blueTotal + blackTotal;
...
document.getElementById('black-plus').addEventListener('click',function(){
   ...
   upadateCaseNumber('black', 59 ,true);
});
